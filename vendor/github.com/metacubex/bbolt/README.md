...
[![Go Report Card](https://goreportcard.com/badge/github.com/metacubex/bbolt?style=flat-square)](https://goreportcard.com/report/github.com/metacubex/bbolt)
[![Go Reference](https://pkg.go.dev/badge/github.com/metacubex/bbolt.svg)](https://pkg.go.dev/github.com/metacubex/bbolt)
...
```sh
$ go get github.com/metacubex/bbolt@latest
```
...
```sh
$ go run github.com/metacubex/bbolt/cmd/bbolt@latest
```
...
```sh
$ go install github.com/metacubex/bbolt/cmd/bbolt@latest
```
...
```go
import bolt "github.com/metacubex/bbolt"
...
system's page cache. See the [`Tx`](https://godoc.org/github.com/metacubex/bbolt#Tx)
